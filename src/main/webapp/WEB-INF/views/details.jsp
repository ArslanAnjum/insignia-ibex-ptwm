...
<head>
	...
	<!-- Bootstrap core CSS -->
	<link href="details/css/bootstrap.min.css" rel="stylesheet">

	<!-- Material Design Bootstrap -->
	<link href="details/css/mdb.css" rel="stylesheet">
...
<body class="model">
	...
	<header>
		...
		<!-- Intro Section -->
		<div id="home" class="view hm-black-slight jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('http://mdbootstrap.com/img/Photos/Others/model-2.jpg');">
	...
	<main>
			...
			<section id="about" class="section py-5">
				...
				<div class="row mt-5 wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="col-lg-4 mb-r flex-center">
						<div class="view">
							<img src="http://mdbootstrap.com/img/Photos/Others/model3.jpg" class="img-fluid z-depth-1" alt="">
						</div>
					</div>
		...
		<!-- streak -->
		<div class="view streak streak-photo streak-md hm-white-slight" style="background-image:url('http://mdbootstrap.com/img/Photos/Horizontal/Nature/12-col/img%20%28131%29.jpg')">
				...
				<div class="row boxed-gallery mb-5 wow fadeIn" data-wow-delay="0.4s">
						...
						<div class="mdb-lightbox no-margin">
							 ...
							 <figure class="col-md-4">
                                <a href="http://mdbootstrap.com/img/Photos/Lightbox/Original/img%20(61).jpg" data-size="781x1172">
                                    <img src="http://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(61).jpg" class="img-fluid">
                                </a>
                            </figure>

                            <figure class="col-md-4">
                                <a href="http://mdbootstrap.com/img/Photos/Lightbox/Original/img%20(139).jpg" data-size="781x1172">
                                    <img src="http://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(139).jpg" class="img-fluid">
                                </a>
                            </figure>

                            <figure class="col-md-4">
                                <a href="http://mdbootstrap.com/img/Photos/Lightbox/Original/img%20(142).jpg" data-size="781x1172">
                                    <img src="http://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(142).jpg" class="img-fluid">
                                </a>
                            </figure>

                            <figure class="col-md-4">
                                <a href="http://mdbootstrap.com/img/Photos/Lightbox/Original/img%20(143).jpg" data-size="781x1172">
                                    <img src="http://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(143).jpg" class="img-fluid">
                                </a>
                            </figure>

                            <figure class="col-md-4">
                                <a href="http://mdbootstrap.com/img/Photos/Lightbox/Original/img%20(141).jpg" data-size="781x1172">
                                    <img src="http://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(141).jpg" class="img-fluid">
                                </a>
                            </figure>

                            <figure class="col-md-4">
                                <a href="http://mdbootstrap.com/img/Photos/Lightbox/Original/img%20(140).jpg" data-size="781x1172">
                                    <img src="http://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(140).jpg" class="img-fluid">
                                </a>
                            </figure>
                        ...
                        <!--Card-->
                            <div class="card card-cascade narrower">
                                ...
                                <div class="view overlay hm-zoom hm-white-slight">
                                    <img src="https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2812%29.jpg" class="img-fluid" alt="">
                                    <a>
					...
					<div class="col-lg-4 col-md-6 mb-r">
                        ...
                        <!--Card-->
                            <div class="card card-cascade narrower">
                                ...
                                <!--Card image-->
                                <div class="view overlay hm-zoom hm-white-slight">
                                    <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/4-col/img%20%28132%29.jpg" class="img-fluid" alt="">
                                    <a>
                                        <div class="mask waves-effect waves-light"></div>
                                    </a>
                                </div>
					...
					<div class="col-lg-4 col-md-6 mb-r">
                        ...
                        <!--Card-->
                            <div class="card card-cascade narrower">
                                ...
                                <!--Card image-->
                                <div class="view overlay hm-zoom hm-white-slight">
                                    <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/4-col/img%20%28120%29.jpg" class="img-fluid" alt="">
                                    <a>
                                        <div class="mask waves-effect waves-light"></div>
                                    </a>
                                </div>
	...
	<!-- JQuery -->
	<script type="text/javascript" src="details/js/jquery-3.1.1.min.js"></script>

	<!-- Bootstrap tooltips -->
	<script type="text/javascript" src="details/js/popper.min.js"></script>

	<!-- Bootstrap core JavaScript -->
	<script type="text/javascript" src="details/js/bootstrap.min.js"></script>

	<!-- MDB core JavaScript -->
	<script type="text/javascript" src="details/js/mdb.js"></script>
