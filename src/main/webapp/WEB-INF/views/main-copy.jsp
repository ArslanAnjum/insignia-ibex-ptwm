        ...
        <div class="container-fluid full-bg-img d-flex align-items-center justify-content-center">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <!--<div class="col-md-10 text-center">
                   ...
                   &lt;!&ndash; Heading &ndash;&gt;
                    <h2 class="display-3 font-bold white-text mb-2">Pakistan 5</h2>
        ...
        <section id="examples" class="text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    ...
                    <div class="view overlay hm-white-slight z-depth-1-half">
                        <img src="img/Photos/Horizontal/nature/6-col/img%20(67).html" class="img-fluid" alt="">
                        <div class="mask"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="view overlay hm-white-slight z-depth-1-half">
                        <img src="img/Photos/Horizontal/nature/6-col/img%20(66).html" class="img-fluid" alt="">
                        <div class="mask"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="view overlay hm-white-slight z-depth-1-half">
                        <img src="img/Photos/Horizontal/nature/6-col/img%20(65).html" class="img-fluid" alt="">
                        <div class="mask"></div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    ...
                    <div class="view overlay hm-white-slight z-depth-1-half">
                        <img src="img/Photos/Horizontal/nature/6-col/img%20(64).html" class="img-fluid" alt="">
                        <div class="mask"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="view overlay hm-white-slight z-depth-1-half">
                        <img src="img/Photos/Horizontal/nature/6-col/img%20(68).html" class="img-fluid" alt="">
                        <div class="mask"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="view overlay hm-white-slight z-depth-1-half">
                        <img src="img/Photos/Horizontal/nature/6-col/img%20(69).html" class="img-fluid" alt="">
                        <div class="mask"></div>
                    </div>
                    ...
                    <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner z-depth-1-half" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="img/Photos/Horizontal/nature/6-col/img%20(82).html" alt="First slide">
                            </div>
                            <!--/First slide-->
                            <!--Second slide-->
                            <div class="carousel-item">
                                <img class="d-block w-100" src="img/Photos/Horizontal/nature/6-col/img%20(88).html" alt="Second slide">
                            </div>
                            <!--/Second slide-->
                            <!--Third slide-->
                            <div class="carousel-item">
                                <img class="d-block w-100" src="img/Photos/Horizontal/nature/6-col/img%20(83).html" alt="Third slide">
                            </div>
                            <!--/Third slide-->
                        </div>
                        <!--/.Slides-->
...
<!--Footer-->
<footer class="page-footer red center-on-small-only unique-color-dark pt-0">
